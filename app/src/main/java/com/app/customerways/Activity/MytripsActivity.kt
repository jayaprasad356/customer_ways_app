...
import com.app.customerways.Adapter.MytriplistAdapter
import com.app.customerways.Model.Mytriplist
import com.app.customerways.R
import com.app.customerways.databinding.ActivityMytripsBinding
...
class MytripsActivity : BaseActivity() {
    ...
    fun mytripList() {
        ...
        }, activity, Constant.MY_PRODUCT_LIST, params, true, 1)
    }
}
