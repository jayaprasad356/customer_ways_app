...
import com.app.customerways.databinding.ActivityInviteFriendsBinding
...
class InviteFriendsActivity : BaseActivity() {
    ...
    var baseUrl: String = "https://play.google.com/store/apps/details?id=com.app.customerways"
