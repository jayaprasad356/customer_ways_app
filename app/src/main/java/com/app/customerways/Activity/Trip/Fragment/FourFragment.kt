...
import com.app.customerways.databinding.FragmentFourBinding
...
class FourFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if ((activity as StarttripActivity).session.getData(Constant.PRODUCT_FROM_DATE) != null) {
            binding.edStartDate.setText((activity as StarttripActivity).session.getData(Constant.PRODUCT_FROM_DATE))
        }

        if ((activity as StarttripActivity).session.getData(Constant.PRODUCT_TO_DATE) != null) {
            binding.edEndDate.setText((activity as StarttripActivity).session.getData(Constant.PRODUCT_TO_DATE))
        }
