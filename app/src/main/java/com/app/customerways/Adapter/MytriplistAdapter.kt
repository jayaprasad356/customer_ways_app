...
import com.app.customerways.Model.Mytriplist
...
//        }
        ...
        Glide.with(activitys).load(report.product_image).placeholder(R.drawable.placeholder_bg)
    ...
    fun deleteTrip(id: String?) {
        ...
        }, activity, Constant.DELETE_PRODUCT, params, true, 1)
